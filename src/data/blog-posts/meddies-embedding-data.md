...
This is the same discipline behind every Meddies synthetic dataset: an LLM is good at producing text inside constraints and unreliable at deciding what the constraints should be. Let the model pick its own difficulty and you get a dataset that is easy to generate and boring to train on.
