      ...
      <div className="video-container my-8">
        <div className="relative w-full bg-muted rounded-lg p-8 text-center" style={{ paddingBottom: '56.25%' }}>
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="mb-4">
              <svg className="size-16 text-muted-foreground" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a
              ...
              className="inline-flex items-center px-4 py-2 bg-red-600 text-primary-foreground rounded-lg hover:bg-red-700 transition-colors"
            >
